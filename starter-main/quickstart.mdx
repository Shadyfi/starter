...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://dashboard.shadyfi.com). To clone the repository
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    1. Install the
    [Shadyfi CLI](https://www.npmjs.com/package/shadyfi) to preview the
    documentation changes locally with this command: ``` npm i -g shadyfi ```
    2. Run the following command at the root of your documentation (where
    `docs.json` is): ``` shadyfi dev ```
    <Note>
      If you’re currently using the legacy ```mint.json``` configuration file, please update the Shadyfi CLI:
...
<Accordion icon="message-bot" title="Install our Github app">
  ...
  your [dashboard](https://dashboard.shadyfi.com). Once the bot has been
...
<Accordion icon="rocket" title="Push your changes">
  ...
  update your docs through our [dashboard](https://dashboard.shadyfi.com).
</Accordion>
